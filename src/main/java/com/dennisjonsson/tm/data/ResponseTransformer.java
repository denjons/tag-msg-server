...
public class ResponseTransformer {
	...
	Response response = new Response(responseDTO.id,
		null/* user id remove! */, responseDTO.request, date);
	...
	// ResponseDTO(String id, String user, String request, String content,
	// String date)

	ResponseDTO responseDTO = new ResponseDTO(response.getId(), response.getRequest(), response.content,
